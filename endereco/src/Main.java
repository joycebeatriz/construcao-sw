public class Main {
    public static void main(String[] args) {
        ...
        // Criando uma instância da classe Logradouro
        Logradouro logradouro = new Logradouro("Avenida Paulista", TipoLogradouro.AVENIDA);
        // Imprimindo o nome e o tipo do logradouro
        System.out.println("Logradouro: " + logradouro.getNome() + " (Tipo: " + logradouro.getTipo() + ")");
    }
}
